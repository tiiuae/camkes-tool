...
typedef size_t (*dataport_get_page_size_fn)(void);
typedef size_t (*dataport_get_page_size_bits_fn)(void);
...
typedef struct {
    ...
    dataport_get_page_size_fn get_page_size;
    dataport_get_page_size_bits_fn get_page_size_bits;
...
static inline size_t dataport_get_page_size(dataport_caps_handle_t *d)
{
    return d->get_page_size();
}

static inline size_t dataport_get_page_size_bits(dataport_caps_handle_t *d)
{
    return d->get_page_size_bits();
}
